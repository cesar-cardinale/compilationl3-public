...
public final class AListedecfoncListedecfonc extends PListedecfonc
{
    private PDecfonc _decfonc_;
    private PListedecfonc _listedecfonc_;

    public AListedecfoncListedecfonc()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AListedecfoncListedecfonc(
    ...
    {
        ((Analysis) sw).caseAListedecfoncListedecfonc(this);
    }
