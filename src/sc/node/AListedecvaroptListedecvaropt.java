...
public final class AListedecvaroptListedecvaropt extends PListedecvaropt
{
    private PListedecvar _listedecvar_;
    private TPointVirgule _pointVirgule_;

    public AListedecvaroptListedecvaropt()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AListedecvaroptListedecvaropt(
    ...
    {
        ((Analysis) sw).caseAListedecvaroptListedecvaropt(this);
    }
