...
public final class AListedecvarListedecvar extends PListedecvar
{
    private PDecvar _decvar_;
    private PListedecvarbis _listedecvarbis_;

    public AListedecvarListedecvar()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AListedecvarListedecvar(
    ...
    {
        ((Analysis) sw).caseAListedecvarListedecvar(this);
    }
