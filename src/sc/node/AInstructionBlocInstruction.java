...
public final class AInstructionBlocInstruction extends PInstruction
{
    private PInstructionBloc _instructionBloc_;

    public AInstructionBlocInstruction()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AInstructionBlocInstruction(
    ...
    {
        ((Analysis) sw).caseAInstructionBlocInstruction(this);
    }
