...
class TokenIndex extends AnalysisAdapter
{
    ...
    @Override
    public void caseTDiviser(@SuppressWarnings("unused") TDiviser node)
    {
        this.index = 3;
    }
    ...
    @Override
    public void caseTParantheseOuvrante(@SuppressWarnings("unused") TParantheseOuvrante node)
    {
        this.index = 6;
    }

    @Override
    public void caseTParantheseFermante(@SuppressWarnings("unused") TParantheseFermante node)
    {
        this.index = 7;
    }
    ...
    @Override
    public void caseTSuperieur(@SuppressWarnings("unused") TSuperieur node)
    {
        this.index = 13;
    }
